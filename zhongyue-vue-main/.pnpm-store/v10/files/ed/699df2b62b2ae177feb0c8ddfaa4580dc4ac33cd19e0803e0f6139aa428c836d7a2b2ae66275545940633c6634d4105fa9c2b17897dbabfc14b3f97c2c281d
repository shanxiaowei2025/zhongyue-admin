...
exports.TranslateMatrix = exports.ScaleMatrix = exports.RotateMatrix = exports.Matrix = void 0;
...
var Matrix = /** @class */ (function (_super) {
    ...
    Matrix.prototype.toPoints = function () {
        return this.map(function (item) { return new vector_1.Point(item[0], item[1]); });
    };
...
var RotateMatrix = /** @class */ (function (_super) {
    ...
    function RotateMatrix(theta) {
        var _this = _super.call(this, new vector_1.Vector(+Math.cos(theta).toFixed(2), +Math.sin(theta).toFixed(2), 0), new vector_1.Vector(-Math.sin(theta).toFixed(2), +Math.cos(theta).toFixed(2), 0), new vector_1.Vector(0, 0, 1)) || this;
...
var ScaleMatrix = /** @class */ (function (_super) {
    ...
    function ScaleMatrix(sx, sy) {
        var _this = _super.call(this, new vector_1.Vector(sx, 0, 0), new vector_1.Vector(0, sy, 0), new vector_1.Vector(0, 0, 1)) || this;
        _this.sx = sx;
        _this.sy = sy;
...
var TranslateMatrix = /** @class */ (function (_super) {
    ...
    function TranslateMatrix(tx, ty) {
        var _this = _super.call(this, new vector_1.Vector(1, 0, 0), new vector_1.Vector(0, 1, 0), new vector_1.Vector(tx, ty, 1)) || this;
        _this.tx = tx;
        _this.ty = ty;
