...
exports.initDefaultShortcut = exports.transformEdgeData = exports.transformNodeData = exports.translateEdgeData = exports.translateNodeData = void 0;
...
function translateEdgeData(edgeData, distance) {
    ...
    if (!(0, lodash_es_1.isEmpty)(edgeData.text)) {
        edgeData.text.x += distance;
        edgeData.text.y += distance;
    }
    return edgeData;
}
exports.translateEdgeData = translateEdgeData;
function transformNodeData(nodeData, distance) {
...
exports.transformNodeData = transformNodeData;
function transformEdgeData(edgeData, distance) {
    ...
    var newPointsList = (0, lodash_es_2.map)(pointsList, function (point) {
        return {
            x: point.x + distance,
            y: point.y + distance,
        };
...
exports.transformEdgeData = transformEdgeData;
