...
exports.isMultipleSelect = exports.isPointInArea = void 0;
/**
 * 判断一个点是否在指定区域
 * @param point 当前点
 ...
 */
var isPointInArea = function (_a, _b, _c) {
 ...
 * 判断鼠标点击选中元素的时候，是否为多选
 */
var isMultipleSelect = function (e, editConfigModel) {
...
exports.isMultipleSelect = isMultipleSelect;
