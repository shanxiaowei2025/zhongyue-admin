...
var TextEditTool = /** @class */ (function (_super) {
    ...
    function TextEditTool(props) {
        ...
        _this.keyupHandler = function (ev) {
            ...
            if (ev.key === 'Enter' && ev.altKey) {
                textEditElement === null || textEditElement === void 0 ? void 0 : textEditElement.setElementState(__1.ElementState.DEFAULT);
            }
        };
    ...
    TextEditTool.getDerivedStateFromProps = function (props) {
        ...
        if (textEditElement) {
            ...
            if (!((_a = textEditElement.text) === null || _a === void 0 ? void 0 : _a.value)) {
                if (textEditElement.BaseType === constant_1.ElementType.EDGE) {
            ...
            if (textEditElement.BaseType === constant_1.ElementType.EDGE) {
            ...
            else if (textEditElement.BaseType === constant_1.ElementType.NODE) {
                // 如果节点文案自动换行, 设置编辑框宽度
                ...
                if ((modelType !== constant_1.ModelType.TEXT_NODE && overflowMode === 'autoWrap') ||
                    (modelType === constant_1.ModelType.TEXT_NODE && textWidth)) {
    ...
    TextEditTool.prototype.componentDidUpdate = function () {
        ...
        if (this.__prevText.id !== '') {
            ...
            graphModel.eventCenter.emit(constant_1.EventType.TEXT_UPDATE, {
    ...
    TextEditTool.prototype.render = function () {
        ...
        return textEditElement ? ((0, jsx_runtime_1.jsx)("div", { contentEditable: true, className: "lf-text-input", style: style, ref: this.ref, onKeyUp: this.keyupHandler, onKeyDown: this.keydownHandler, onKeyPress: this.keydownHandler, onInput: this.inputHandler, children: (_a = textEditElement.text) === null || _a === void 0 ? void 0 : _a.value }, textEditElement.id)) : null;
    };
