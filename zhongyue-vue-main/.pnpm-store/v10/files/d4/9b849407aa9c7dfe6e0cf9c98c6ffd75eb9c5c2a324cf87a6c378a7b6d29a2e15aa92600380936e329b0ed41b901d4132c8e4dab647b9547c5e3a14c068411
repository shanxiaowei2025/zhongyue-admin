...
exports.CircleNodeModel = void 0;
...
var CircleNodeModel = /** @class */ (function (_super) {
    ...
    function CircleNodeModel(data, graphModel) {
        ...
        _this.modelType = constant_1.ModelType.CIRCLE_NODE;
    ...
    CircleNodeModel.prototype.getNodeStyle = function () {
        ...
        return __assign(__assign(__assign({}, style), (0, lodash_es_1.cloneDeep)(circle)), (0, lodash_es_1.cloneDeep)(customStyle));
    };
...
exports.CircleNodeModel = CircleNodeModel;
exports.default = CircleNodeModel;
